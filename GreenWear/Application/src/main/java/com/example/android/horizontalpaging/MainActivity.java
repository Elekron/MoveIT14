...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message = intent.getStringExtra(LoginActivity.LOGIN_MESSAGE);
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    args.putInt(ReceiptsFragment.ARG_SECTION_NUMBER, position + 1);
                    fragment.setArguments(args);
                    return fragment;
                case 2:
                    fragment = new RecyclingCenterFragment();
                    args.putInt(RecyclingCenterFragment.ARG_SECTION_NUMBER, position + 1);
                    fragment.setArguments(args);
                    return fragment;
                case 3:
...
//            dummyTextView.setText("ProfileFragment "+Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
    ...
    public static class ReceiptsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView dummyTextView = (TextView) rootView.findViewById(R.id.section_label);
            dummyTextView.setText("ReceiptsFragment "+Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
     ...
     * This would be replaced with your application's content.
     */
    public static class RecyclingCenterFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
        ...
        public RecyclingCenterFragment() {
        }

        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_recycling, container, false);
            TextView dummyTextView = (TextView) rootView.findViewById(R.id.section_label);
            dummyTextView.setText("RecyclingCenterFragment "+Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
