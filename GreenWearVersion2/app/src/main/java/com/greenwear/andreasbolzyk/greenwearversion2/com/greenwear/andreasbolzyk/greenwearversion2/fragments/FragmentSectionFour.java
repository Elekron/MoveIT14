...
public class FragmentSectionFour extends Fragment {
    /**
     ...
     * number.
     */
    public static FragmentSectionFour newInstance(int sectionNumber) {
        FragmentSectionFour fragment = new FragmentSectionFour();
